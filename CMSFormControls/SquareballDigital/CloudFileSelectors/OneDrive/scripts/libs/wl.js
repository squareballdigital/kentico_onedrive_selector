        ...
        (function () {
            ...
            function showPicker(props) {
                ...
                function setScale(){
                    ...
                    var testW=document.body.clientWidth;
                    if(testW/800<1){
                        var scale="scale("+testW/800+")";
                        iframe.style['-webkit-transform'] = scale;
                        iframe.style['-webkit-transform-origin'] = "0 0";
                        iframe.style['-moz-transform'] = scale;
                        iframe.style['-moz-transform-origin'] = "0 0";
                        iframe.style['-o-transform'] = scale;
                        iframe.style['-o-transform-origin'] = "0 0";
                    }
                }
                setScale();
...
// -----------------------------------
        ...
        wl_app[API_X_HTTP_LIVE_LIBRARY] = "Web/DEVICE_" + trimVersionBuildNumber("5.5.8613.4000");
